...
//                if isReflect {
//                    // "Share How You're Doing" card for REFLECT prompt
//                    reflectCard
//                        .opacity(appeared ? 1 : 0)
...
//                }
                ...
                // Tap to dismiss hint
                Text(isReflect ? "Tap background to close" : "Tap anywhere to continue")
        ...
        .onTapGesture {
            if isReflect {
                // Dismiss keyboard first, then dismiss view if keyboard wasn't focused
                if isTextFocused {
                    isTextFocused = false
                } else {
                    onDismiss()
